 ...
 *
 * Moved from app/utils/enemyAvatar.ts (enemy-bestiary): this logic has no
 * client-only dependency and the bestiary API (server/services/character.service.ts)
 * needs the same portrait resolution as the frontend combat result panel.
 */
