...
export const ACHIEVEMENT_TEMPLATES: Record<string, AchievementTemplate> = {
    ...
    'weapon_apprentice': {
        templateId: 'weapon_apprentice',
        type: AchievementType.WEAPON_PROFICIENCY_LEVEL,
        name: '熟能生巧',
        description: '任一武器類型熟練度達到 Lv.5',
        targetCount: 5,
        mode: 'PEAK',
        rewardGems: 5,
    },
    ...
    'dual_wield_mastery': {
        templateId: 'dual_wield_mastery',
        type: AchievementType.WEAPON_MASTERY_DUAL_WIELD,
        name: '雙持宗師',
        description: '雙持熟練度達到 Lv.10',
        targetCount: 10,
        mode: 'PEAK',
        rewardGems: 8,
    },
    'pentagonal_mastery': {
        templateId: 'pentagonal_mastery',
        type: AchievementType.WEAPON_TYPES_MASTERED,
        name: '五絕宗師',
        description: '五種武器類型的熟練度皆達到 Lv.10',
        targetCount: 5,
        rewardGems: 10,
    },
};
