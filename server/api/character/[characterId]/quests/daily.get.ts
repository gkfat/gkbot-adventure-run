...
import { getDailyQuestsResponseSchema } from '../../../../../shared/schemas/api/quest.schema';
...
export default defineEventHandler(async (event) => {
    ...
    try {
        ...
        const quests = await questService.getOrGenerateDaily(characterId);
        ...
        return getDailyQuestsResponseSchema.parse(response);
    } catch (error: unknown) {
        logRequest({
            severity: 'ERROR',
