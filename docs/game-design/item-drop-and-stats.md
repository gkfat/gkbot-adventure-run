...
## 頭部 Head（對應現有模板 `gkbot_faceplate`）
...
## 身體 Body（對應現有模板 `supply_crate_vest`）

| 稀有度 | 名稱 | DEF | HP | 售價 |
|---|---|---|---|---|
| N | 工程防護背心 | 5–9 | 15–25 | 金幣 100–200 |
| R | 防爆維修外套 | 9–16 | 25–50 | 金幣 300–500 |
| SR | 實驗室隔離衣 | 16–26 | 50–85 | 金幣 800–1200 + 寶石 10–20 |
| SSR | GkBot 搬運工背甲 *(替代款：私兵繳獲護甲)* | 26–38 | 85–130 | 寶石 30–50 |
| L | 緊急維生外套 | 38–55 | 130–190 | 寶石 80–120 |

## 左手 Left Hand（對應現有模板 `riot_shield_scrap`，DEF）

| 稀有度 | 名稱 | DEF | 售價 |
|---|---|---|---|
| N | 工程護腕 | 4–8 | 金幣 100–200 |
| R | 磁吸工具腕帶 | 8–16 | 金幣 300–500 |
| SR | 維修端子手套 | 16–28 | 金幣 800–1200 + 寶石 10–20 |
| SSR | 液壓作業護臂 *(替代款：掠奪者綁帶護具)* | 28–42 | 寶石 30–50 |
| L | 舊式校準手環 | 42–60 | 寶石 80–120 |

## 右手 Right Hand（對應現有模板 `salvaged_wrench`，ATK）
...
## 戒指 Ring（對應現有模板 `research_chip_ring`，actionSpeedMod，負值＝行動更快）

| 稀有度 | 名稱 | actionSpeedMod | 售價 |
|---|---|---|---|
| N | GK 員工識別環 | -0.04 ~ -0.02 | 金幣 100–200 |
| R | 備用記憶環 | -0.08 ~ -0.04 | 金幣 300–500 |
| SR | 微型磁力環 | -0.14 ~ -0.08 | 金幣 800–1200 + 寶石 10–20 |
| SSR | 實驗型同步環 | -0.22 ~ -0.14 | 寶石 30–50 |
| L | 無標記黑環 *(替代款：陣亡倖存者的婚戒)* | -0.32 ~ -0.22 | 寶石 80–120 |

> 戒指第 6 則文案（婚戒）伏筆最重，因此不放在替代 SSR，而是直接作為 L 的替代款，呼應「戒指承擔身份／記憶伏筆」的既定方向。

## 鞋子 Feet（對應現有模板 `servo_greaves`，DEF + actionSpeedMod）

| 稀有度 | 名稱 | DEF | actionSpeedMod | 售價 |
|---|---|---|---|---|
| N | 工程安全靴 | 2–4 | -0.05 ~ -0.02 | 金幣 100–200 |
| R | 維修通道靴 | 4–8 | -0.1 ~ -0.05 | 金幣 300–500 |
| SR | 靜音工作鞋 | 8–14 | -0.18 ~ -0.1 | 金幣 800–1200 + 寶石 10–20 |
