...
- **THEN** 兩個實體的 `name`/`description` 不同，且分別等於 `docs/game-design/mechanics/content/items.md` 第 4 節「右手 Right Hand」對照表中 N 稀有度、L 稀有度所定案的文案
